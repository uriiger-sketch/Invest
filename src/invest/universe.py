...
_CORE: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("TSEM", "Tower Semiconductor", "Technology", "IL"),
    ("KRNT", "Kornit Digital", "Technology", "IL"),
    ("SPNS", "Sapiens International", "Technology", "IL"),
    ...
    ("ARBE", "Arbe Robotics", "Technology", "IL"),
    ("SMWB", "Similarweb", "Technology", "IL"),
    ("PAYO", "Payoneer Global", "Financials", "IL"),
    ("RSKD", "Riskified", "Technology", "IL"),
    ("HIPO", "Hippo Holdings", "Financials", "IL"),
    ("ZIM", "ZIM Integrated Shipping", "Industrials", "IL"),
    ("PERI", "Perion Network", "Communication Services", "IL"),
    ("ORA", "Ormat Technologies", "Utilities", "IL"),
    ("MTSI", "MACOM Technology Solutions", "Technology", "IL"),
    ("BLND", "Blend Labs", "Technology", "IL"),
    ...
    ("PRX.AS", "Prosus N.V.", "Technology", "EU"),
    ("SPOT", "Spotify Technology", "Communication Services", "EU"),
    ("CRWV", "Coreweave", "Technology", "EU"),
    ("FERG", "Ferguson Enterprises", "Industrials", "EU"),
    ("ACGL", "Arch Capital Group", "Financials", "EU"),
    ("JCI", "Johnson Controls International", "Industrials", "EU"),
    ("TT", "Trane Technologies", "Industrials", "EU"),
    ("STLD", "Steel Dynamics", "Materials", "EU"),
    ("WCC", "WESCO International", "Industrials", "EU"),
    ("GRAB", "Grab Holdings", "Technology", "EU"),
    ("UMC", "United Microelectronics", "Technology", "EU"),
    ("PSO", "Pearson plc", "Communication Services", "EU"),
    ("WPP", "WPP plc", "Communication Services", "EU"),
    ("SSL", "Sasol Limited", "Energy", "EU"),
    ("GOLD", "Barrick Mining", "Materials", "EU"),
    ("AEM", "Agnico Eagle Mines", "Materials", "EU"),
    ("RACE", "Ferrari N.V.", "Consumer Discretionary", "EU"),
    ("STLA", "Stellantis N.V.", "Consumer Discretionary", "EU"),
    ("LVMUY", "LVMH Moet Hennessy Louis Vuitton", "Consumer Discretionary", "EU"),
    ("LRLCY", "L'Oreal S.A.", "Consumer Staples", "EU"),
    ("EADSY", "Airbus SE", "Industrials", "EU"),
    ("SIEGY", "Siemens AG", "Industrials", "EU"),
    ("BAYRY", "Bayer AG", "Health Care", "EU"),
    ("BASFY", "BASF SE", "Materials", "EU"),
    ("DTEGY", "Deutsche Telekom AG", "Communication Services", "EU"),
    ("ALIZY", "Allianz SE", "Financials", "EU"),
    ("ADYEY", "Adyen N.V.", "Technology", "EU"),
    ("IFNNY", "Infineon Technologies AG", "Technology", "EU"),
    ("BNPQY", "BNP Paribas S.A.", "Financials", "EU"),
    ("BBVA", "Banco Bilbao Vizcaya Argentaria", "Financials", "EU"),
    ("IBDRY", "Iberdrola S.A.", "Utilities", "EU"),
    ("ENLAY", "Enel S.p.A.", "Utilities", "EU"),
    ("ADDYY", "Adidas AG", "Consumer Discretionary", "EU"),
    ("VWAGY", "Volkswagen AG", "Consumer Discretionary", "EU"),
    ("BMWYY", "Bayerische Motoren Werke AG", "Consumer Discretionary", "EU"),
    ("MBGYY", "Mercedes-Benz Group AG", "Consumer Discretionary", "EU"),
    ("CFRUY", "Compagnie Financiere Richemont", "Consumer Discretionary", "EU"),
    ("NSRGY", "Nestle S.A.", "Consumer Staples", "EU"),
    ("RHHBY", "Roche Holding AG", "Health Care", "EU"),
    ("DASTY", "Dassault Systemes SE", "Technology", "EU"),
    ("SBGSY", "Schneider Electric SE", "Industrials", "EU"),
    ("SAFRY", "Safran SA", "Industrials", "EU"),
